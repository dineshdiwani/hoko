  ...
  return (
    <div className="page flex flex-col">
      ...
      <header className="sticky top-0 z-40 bg-white shadow-sm">
        <div className="max-w-6xl mx-auto flex items-center justify-between px-4 py-3 pl-16 md:pl-20">
          <div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative" ref={menuRef}>
              <button
                ...
                className="flex items-center gap-1 px-3 py-2 border rounded-xl text-sm font-medium bg-white"
              >
        ...
        <div className="max-w-6xl mx-auto px-4 pb-3 pl-16 md:pl-20">
          <div className="flex items-center gap-3">
            ...
            <select
              ...
              className="w-auto max-w-full px-4 py-3 rounded-xl border text-base"
            >
