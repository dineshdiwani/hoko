      ...
      <div className="relative w-full">
        {useNativeGoogleLogin ? (
          ...
          <button
            ...
            className={`w-full h-[44px] rounded-xl border border-slate-300 bg-white text-sm font-semibold text-slate-600 inline-flex items-center justify-center gap-2 ${disabled ? "opacity-50 cursor-not-allowed" : ""}`}
          >
            <span className="inline-flex h-5 w-5 items-center justify-center">
              <svg viewBox="0 0 48 48" className="h-4 w-4" aria-hidden="true">
                <path
