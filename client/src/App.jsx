  ...
  return (
    <>
      ...
      {showGlobalLogo && (
        <Link
          to="/"
          className="fixed top-4 left-4 z-50 flex items-center gap-2 rounded-full bg-white/90 backdrop-blur px-3 py-2 shadow-lg"
        ...
        >
          ...
          />
          <span className="text-base font-extrabold text-hoko-brand">
