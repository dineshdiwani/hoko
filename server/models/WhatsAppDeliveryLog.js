...
const whatsAppDeliveryLogSchema = new mongoose.Schema(
  {
    ...
    triggerType: {
      type: String,
      enum: ["buyer_post", "buyer_invite", "buyer_requirement_ack", "seller_requirement_notify", "seller_manual_campaign", "manual_resend", "manual_test", "manual_queue", "template_send"],
      default: "buyer_post"
    },
    channel: {
      type: String,
