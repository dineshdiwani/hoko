...
const CRITERIA_QUERY = /^(facebookexternalhit|facebookcatalog|facebookplatform|Facebot|LinkedInBot|Twitterbot|WhatsApp|GoogleBot|bingbot|Slackbot|Discordbot|TelegramBot)/i;
